...
import { validateSequenceModel } from '../../knowledge/sequence/model.mjs';
import { drawableDiagnostics } from './drawable.mjs';
import { canonical, digest, fail } from '../../knowledge/shared/model.mjs';
import { wrap, units } from '../shared/model.mjs';
import { isBehavior, assertionOf, regionsOf } from '../../knowledge/sequence/structure.mjs';
import { drawingOrder, nestingDepth } from './structure.mjs';
import { blockLines, regionLines, bandHeight, frameDiagnostics } from './frames.mjs';
import { assertedEntry } from '../../knowledge/sequence/entry.mjs';
