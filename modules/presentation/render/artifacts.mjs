...
export function extractLayout(artifact) {
  ...
  if (artifact.includes('<meta name="waxwing-artifact" content="site-page">')) fail('This is one page of a Waxwing site. Recover from the exported directory or its source/layout.json to retain the complete model.');
