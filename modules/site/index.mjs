...
import { digest, existenceText } from '../shared/model.mjs';
import { selectHighlights, setDiagramFocus } from '../render/highlights.mjs';
import { modelRecords } from '../query/index.mjs';
...
export function renderSite(layout, options = {}) {
  assertLayout(layout);
  if (Object.keys(options).some((k) => !['skin','publication'].includes(k))) throw new Error('Unknown site render option. The output structure is fixed.');
